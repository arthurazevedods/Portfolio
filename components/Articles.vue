        ...
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="p-4 md:w-1/3 flex">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-indigo-400 mb-4 flex-shrink-0">
                    <font-awesome icon="fa-brands fa-php" class='w-8 h-8'/>
                </div>
            ...
            <div class="p-4 md:w-1/3 flex">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-indigo-400 mb-4 flex-shrink-0">
                    <font-awesome icon="fa-regular fa-file-code" class='w-8 h-8'/>
                </div>
                <div class="flex-grow pl-6">
            ...
            <div class="p-4 md:w-1/3 flex">
                <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-indigo-400 mb-4 flex-shrink-0">
                    <font-awesome icon="fa-brands fa-html5" class='w-8 h-8'/>
                </div>
                <div class="flex-grow pl-6">
                <h2 class="text-white text-lg title-font font-medium mb-2">O Básico de HTML</h2>
                <p class="leading-relaxed text-base">
                    O Desenvolvimento WEB é sem dúvidas um dos mais importantes ramos da TI e sua demanda tem crescido excessivamente ao longo dos anos, então é um área que desperta o interesse de diversas pessoas.
